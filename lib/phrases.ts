...
export const phrases: Phrase[] = [
  ...
  { id: 'rip-020', english: 'RIP', japanese: 'ご愁傷様', pronunciation: 'アール・アイ・ピー', phonetic: '/ˌɑːr aɪ ˈpiː/', example: 'RIP his internet connection.', exampleJa: '彼のネット回線に、安らかな眠りを（回線落ちしたね）。', tip: '誰かがミスをした時や、機材が死んだ時に軽く使います。', category: 'stream' },
  ...
  { id: 'raid-022', english: 'Raid', japanese: 'レイド', pronunciation: 'レイド', phonetic: '/reɪd/', example: 'Thanks for the raid!', exampleJa: 'レイド（大移動）ありがとう！', tip: '配信終了時にリスナーを別の配信へ送り込む機能のことです。', category: 'stream' },
  ...
  { id: 'clueless-024', english: 'Clueless', japanese: 'わかってないｗ', pronunciation: 'クルーレス', phonetic: '/ˈkluː.ləs/', example: 'He is clueless about the trap.', exampleJa: '彼は罠があることに全く気づいてないね。', tip: '本人が何も気づいていない様子をリスナーが笑う時に使います。', category: 'slang' },
  { id: 'skill-issue-025', english: 'Skill issue', japanese: '実力不足だなｗ', pronunciation: 'スキル・イシュー', phonetic: '/skɪl ˈɪʃ.uː/', example: 'Dying to the first boss? Skill issue.', exampleJa: '最初のボスで死んだ？それは単に腕が悪いだけだ。', tip: 'ミスを「実力不足」と煽る時に使われる煽り文句。', category: 'slang' },

  // その他
  { id: 'malding-026', english: 'Malding', japanese: 'ブチギレてる', pronunciation: 'モールディング', phonetic: '/ˈmɔːldɪŋ/', example: 'He is malding over the lag.', exampleJa: '彼はラグのせいでブチギレてるね。', tip: 'Mad（怒る）＋ Balding（ハゲる）の造語で、激怒する様子。', category: 'slang' },
  { id: 'kekw-027', english: 'KEKW', japanese: '爆笑', pronunciation: 'ケェク', phonetic: '/kek/', example: 'That mistake was KEKW.', exampleJa: 'あのミスは草だったわ。', tip: 'Twitchで爆笑しているおじさんの顔文字を表す言葉。', category: 'slang' },
  { id: 'hopium-028', english: 'Hopium', japanese: '過度な期待', pronunciation: 'ホーピウム', phonetic: '/ˈhoʊpiəm/', example: 'Still hoping for a sequel? That is pure hopium.', exampleJa: 'まだ続編を期待してるの？それは淡い期待だよ。', tip: 'Hope（希望）＋ Opium（阿片）。現実離れした期待のこと。', category: 'slang' },
  { id: 'tldr-029', english: 'TL;DR', japanese: '要約すると', pronunciation: 'ティー・エル・ディー・アール', phonetic: '/ˌtiː el diː ˈɑːr/', example: 'TL;DR: The game is bad.', exampleJa: '要約：このゲームはクソ。', tip: 'Too Long; Didn\'t Read. 長すぎて読めない人へのまとめ。', category: 'slang' },
  { id: 'cooking-030', english: 'Let him cook', japanese: '自由にさせてやれ', pronunciation: 'レット・ヒム・クック', phonetic: '/let hɪm kʊk/', example: 'Wait, let him cook.', exampleJa: '待て、彼にやらせてみろ（何か企んでるぞ）。', tip: '彼が「料理中（＝何か良いことを計画中）」だから邪魔するな、の意。', category: 'slang' },

  // 追加チャット用語
  { id: 'hype-train-031', english: 'Hype Train', japanese: '盛り上げタイム', pronunciation: 'ハイプ・トレイン', phonetic: '/haɪp treɪn/', example: 'The hype train has started!', exampleJa: 'ハイプトレインが始まったぞ！', tip: 'Twitchでサブスクなどが短時間に重なった時のボーナスタイム。', category: 'stream' },
  { id: 'ez-032', english: 'EZ', japanese: '余裕・簡単すぎ', pronunciation: 'イージー', phonetic: '/ˈiːzi/', example: 'EZ win.', exampleJa: '余裕の勝利。', tip: 'Easyの略。煽りとして使われることも多いので注意。', category: 'slang' },
  { id: 'aimbot-033', english: 'Aimbot', japanese: 'エイムが神', pronunciation: 'エイムボット', phonetic: '/ˈeɪmbɒt/', example: 'Is she using aimbot?', exampleJa: '彼女、エイムボット（チート）使ってる？（それほど上手い）', tip: 'エイムがあまりに正確な時に使われる称賛（または疑い）。', category: 'stream' },
  { id: 'throw-034', english: 'Throwing', japanese: 'やらかし', pronunciation: 'スローイング', phonetic: '/ˈθroʊɪŋ/', example: 'Stop throwing the game!', exampleJa: '試合を投げ出すのはやめて！', tip: 'わざと負けるようなプレイや、致命的なやらかしを指します。', category: 'stream' },
  { id: 'toxic-035', english: 'Toxic', japanese: '有害な、攻撃的な', pronunciation: 'トキシック', phonetic: '/ˈtɒksɪk/', category: 'slang', example: 'The chat is getting toxic.', exampleJa: 'チャットが荒れてきた（攻撃的になってきた）ね。', tip: '他人を不快にさせるような攻撃的な態度や人を指します。' }
];
